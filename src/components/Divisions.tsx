      ...
      <div className="divisions-grid">
        ...
        <div className="division-card reveal">
          ...
          <div className="division-image">
            <img src="/health.jpg" alt="Health Division Product" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
          </div>
        ...
        <div className="division-card reveal">
          ...
          <div className="division-image">
            <img src="/transport.jpg" alt="Transport Division" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
          </div>
        ...
        <div className="division-card reveal">
          ...
          <div className="division-image">
            <img src="/property.jpg" alt="Property Division" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
          </div>
